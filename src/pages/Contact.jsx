...
const Contact = () => {
    ...
    return (
        <div className="pt-16 bg-white dark:bg-gray-900 font-sans min-h-screen">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                    {/* Contact Information */}
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-xl shadow p-6 md:p-8">
                        ...
                        <div className="space-y-8">
                                ...
                                <div>
                                    ...
                                    <div className="mt-4">
                                        <iframe
                                            ...
                                            title="Tetrahedron College Location"
                                        ></iframe>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <a className="mt-1 text-gray-600 dark:text-gray-300 block" href="tel:+917008222977">7008222977</a>
                                </div>
                            </div>
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            <div>
                                ...
                                <input
                                    ...
                                    autoComplete="name"
                                    required
                                    className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-800 dark:border-gray-600 dark:text-white"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows="5"
                                    required
                                    className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-800 dark:border-gray-600 dark:text-white resize-none"
                                ></textarea>
                            </div>
                            ...
                            <div>
                                <button
                                    type="submit"
                                    className="w-full inline-flex justify-center py-2 px-6 border border-transparent shadow-sm text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:bg-indigo-500 dark:hover:bg-indigo-600 transition duration-150 ease-in-out"
                                >
                                    Send Message
                                </button>
                            </div>
