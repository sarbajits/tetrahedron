                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        ...
                        <p className="text-gray-300">
                            Tetrahedron Group of Institutions is a leading residential science college nurturing academic excellence since 2013.
                        </p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            <a href="https://www.facebook.com/people/Tetrahedron-Tangi/100089418667693/" className="text-gray-300 hover:text-white">
                                <span className="sr-only">Facebook</span>
                                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                                </svg>
                            </a>
                            <a href="https://www.instagram.com/tetrahedrongroup" className="text-gray-300 hover:text-white">
                            ...
                            <a href="https://www.youtube.com/watch?v=yWgNetIZ0vU" className="text-gray-300 hover:text-white">
